...
function fullscreen() {
    ...
    if (fulltext == "full") {
        ...
        $("#imgfull").attr("src", "static/style/images/exitfullscreen.png");
        $("#imgfullfont").attr("src", "static/style/images/exitfullscreenfont.png");
        toggleFull();
    }else {
        $("#imgfull").attr("alt", "full");
        $("#imgfull").attr("src", "static/style/images/fullscreen.png");
        $("#imgfullfont").attr("src", "static/style/images/fullscreenfont.png");
        toggleFull();
    }
}