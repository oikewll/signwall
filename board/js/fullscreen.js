...
function fullscreen() {
    ...
    if (fulltext == "full") {
        ...
        $("#imgfull").attr("src", "board/style/images/exitfullscreen.png");
        $("#imgfullfont").attr("src", "board/style/images/exitfullscreenfont.png");
        toggleFull();
    }else {
        $("#imgfull").attr("alt", "full");
        $("#imgfull").attr("src", "board/style/images/fullscreen.png");
        $("#imgfullfont").attr("src", "board/style/images/fullscreenfont.png");
        toggleFull();
    }
}